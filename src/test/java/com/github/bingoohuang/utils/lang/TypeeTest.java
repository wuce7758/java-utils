...
import static com.github.bingoohuang.utils.lang.Typee.getActualTypeArgument;
...
public class TypeeTest {
    ...
    @Test
    public void test1() {
        Class<?> typeArgument = getActualTypeArgument(MyClass.class, MyInterface.class);
    ...
    @Test
    public void test2() {
        Class<?> typeArgument = getActualTypeArgument(MyBClass.class, MyInterface.class);
        assertThat(typeArgument).isSameAs(String.class);
    }
    ...
    @Ignore
    public void test3() {
        Class<?> typeArgument = getActualTypeArgument(MyCClass.class, MyInterface.class);
